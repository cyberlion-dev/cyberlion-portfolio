...
export default function About() {
  ...
  const skills = [
    ...
    },
    {
      icon: <Users size={32} />,
      title: 'Collaboration',
      description: 'Working effectively with teams to bring ideas to life and solve complex problems.',
    },
  ];
  ...
  const techStack = [
    ...
    },
    {
      ...
      icon: '🔧',
      technologies: ['Node.js', 'FastAPI', 'Entity Framework', 'REST APIs', 'GraphQL'],
    },
    {
      category: 'Databases',
      icon: '💾',
        ...
        <div className="tech-stack">
          ...
          <div className="tech-disclaimer flex items-center justify-center gap-3 p-6 rounded-lg border-2 border-dashed border-primary/30 bg-primary/5">
            ...
            <p className="text-sm text-muted-foreground italic max-w-2xl text-center">
              This list is ever-evolving — I&apos;m a lifelong learner always exploring new technologies and expanding my toolkit.
              If you don&apos;t see a specific tech here, there&apos;s a good chance I&apos;m either learning it now or ready to dive in!
            </p>
            <span className="text-2xl">📚</span>
          </div>
        </div>
