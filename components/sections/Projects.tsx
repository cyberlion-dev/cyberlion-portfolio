...
const projects: Project[] = [
  ...
  //   image: 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=800&h=600&fit=crop', // Replace with actual screenshot
  //   tags: ['AI Voice Synthesis', 'Audio Processing', 'Eleven Labs', 'WordPress', 'Custom Player', 'E-Commerce'],
  //   category: 'Personal Project',
  //   role: 'Creator & Lead Developer',
  //   liveUrl: 'https://walkup-beats.com',
  //   isPrivateRepo: true,
  //   featured: true,
  // },
  {
