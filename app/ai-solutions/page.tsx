...
export const metadata: Metadata = {
  ...
  description: "Transform your business with intelligent AI solutions. Custom chatbots, process automation, AI integration, and machine learning implementations tailored to your needs.",
};
